const TeamCard = ({ member }) => {
  return (
    <div className="text-center group transform hover:-translate-y-2 transition  border border-orange-200 rounded-3xl p-4 bg-white shadow-md hover:shadow-[0_0_15px_#fb923c]">
      {/* Image */}
