...
const ProductsHero = () => {
  ...
  return (
    <section className="py-20 bg-gray-50 text-center">
      ...
      >
        {/* Top Label */}
        <p className=" text-xs md:text-sm  tracking-widest text-orange-500 font-semibold uppercase">
          {t("freshly") || "Freshly Squeezed"}
        </p>

        {/* Heading */}
        <h1 className="mt-4 text-3xl md:text-6xl font-bold leading-tight text-gray-900">
          {t("nature") || "Nature's"}{" "}
